      ...
      <ul class="navbar-nav">
		...
		<li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
			...
			<li><a class="dropdown-item" href="http://localhost/Marvisur/Consultas/principal9.php">Consulta 9</a></li>
			<li><a class="dropdown-item" href="http://localhost/Marvisur/Consultas/principal10.php">Consulta 10</a></li>
          </ul>
        </li> 		     
      </ul>
    </div>
